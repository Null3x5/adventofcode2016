...
function movePosition(position, command)
{
	...
	{
		if(command == 'U'){return '2'}
		if(command == 'D'){return 'A'}
		if(command == 'L'){return '5'}
		if(command == 'R'){return '7'}
	}
	if(position == '7')
	{
		if(command == 'U'){return '3'}
		if(command == 'D'){return 'B'}
		if(command == 'L'){return '6'}
		if(command == 'R'){return '8'}
	}
	if(position == '8')
	{
		if(command == 'U'){return '4'}
		if(command == 'D'){return 'C'}
		if(command == 'L'){return '7'}
		if(command == 'R'){return '9'}
	}
	if(position == '9')
	{
		if(command == 'U'){return '9'}
	...
	if(position == 'A')
	{
		...
		if(command == 'D'){return 'A'}
		if(command == 'L'){return 'A'}
		if(command == 'R'){return 'B'}
	}
	if(position == 'B')
	{
		if(command == 'U'){return '7'}
		if(command == 'D'){return 'D'}
		if(command == 'L'){return 'A'}
		if(command == 'R'){return 'C'}
	}
	if(position == 'C')
	{
		if(command == 'U'){return '8'}
		if(command == 'D'){return 'C'}
		if(command == 'L'){return 'B'}
		if(command == 'R'){return 'C'}
	}
	if(position == 'D')
	{
		if(command == 'U'){return 'B'}
		if(command == 'D'){return 'D'}
		if(command == 'L'){return 'D'}
		if(command == 'R'){return 'D'}
	}
	//	Key pad
	//    1
	//  2 3 4
